...
**[Живое демо →](https://omp-moderator.vercel.app)** Чат, в котором работает тот же фильтр, что и в компоненте. Попробуйте пронести рекламу или мат.
...
| `demo/` | Страница живого демо: логика фильтра, перенесённая на JavaScript. Публикуется на Vercel при каждом пуше |
